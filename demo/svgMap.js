...
//colocando comentado o pais some do mapa
...
svgMap.prototype.getTooltipContent = function (countryID) {
  ...
  if (!this.options.data.values[countryID]) {
    ...
    Object.keys(this.options.data.values[countryID]).forEach(function (key) {
      ...
      tooltipContentTable += '<tr><td>' + (key || '') + '</td><td>' + value + '</td></tr>';
    }.bind(this));
    tooltipContentTable += '</table>';
